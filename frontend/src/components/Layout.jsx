    ...
    <>
      {isMobile && (
        <div style={{
          ...
          padding: '0 16px', background: '#fff', borderBottom: `1px solid ${C.border}`,
...
export function Footer(){
  return(
    <div style={{background:'#0f172a',color:'#475569',padding:'16px 28px',
      display:'flex',alignItems:'center',justifyContent:'space-between',fontSize:13,borderTop:'1px solid #1e293b'}}>
      ...
      <a href="https://github.com/PratikKothare123" target="_blank" rel="noreferrer"
        style={{display:'flex',alignItems:'center',gap:7,color:'#94a3b8',textDecoration:'none',fontWeight:600,
          padding:'5px 12px',border:'1px solid #1e293b',borderRadius:7}}>
