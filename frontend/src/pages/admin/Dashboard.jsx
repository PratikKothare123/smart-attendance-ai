...
import { C, Card, StatCard, PageWrap, COLLEGE } from '../../components/ui';
          ...
          {actions.map(a=>(
            <Card key={a.to} style={{padding:24,border:`1.5px solid ${a.color}20`,cursor:'pointer'}}>
              ...
              <Link to={a.to} style={{textDecoration:'none'}}>
                <span style={{background:a.color,color:'#fff',padding:'8px 16px',borderRadius:8,fontWeight:600,fontSize:13}}>Go →</span>
              </Link>
            </Card>
          ))}
        </div>
